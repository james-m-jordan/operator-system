...
- `archive/` - retired report systems and inactive automation artifacts.

Keep raw history, private exports, and credentials-derived evidence outside this
folder unless the file is explicitly safe to commit.
